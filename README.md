...
- **Modo Portable vs Estándar**: Elicia guardar todo en la misma carpeta o en tu perfil de usuario al iniciar.
- **Corazón del Sistema**: Notificaciones de actualización automáticas vinculadas a GitHub.
